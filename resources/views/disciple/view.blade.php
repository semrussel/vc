        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="{{ url($disciple->picture) }}" alt="User profile picture">

              <h3 class="profile-username text-center">{{ $disciple->firstName }} {{ $disciple->lastName }}</h3>

              <p class="text-muted text-center">{{ $disciple->nickName }}</p>

              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Network</b> <a class="pull-right">1,322</a>
                </li>
                <li class="list-group-item">
